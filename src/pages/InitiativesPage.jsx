...
function InitiativesPage() {
  ...
  const handleTechToursClick = () => {
    navigate('/tech-tours');
  };

  const handlePodcastsClick = () => {
    navigate('/', { state: { scrollToPodcasts: true } });
  };
  ...
  return (
    <div className="container mx-auto px-4 py-12 sm:py-16 md:py-20">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 md:gap-8 max-w-6xl mx-auto">
        <div 
          className="bg-white py-5 sm:py-6 md:py-8 px-4 sm:px-5 md:px-6 rounded-lg shadow-md hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 hover:bg-blue-50 initiative-box cursor-pointer"
          onClick={handleTechToursClick}
        >
          ...
          <div className="mt-4 text-[#1fc9d5] text-xs sm:text-sm font-semibold">
            Click to view our tech tours <i className="fas fa-arrow-right ml-1"></i>
          </div>
        </div>
        ...
        >
          ...
          <div className="mt-4 text-[#1fc9d5] text-xs sm:text-sm font-semibold">
            Click to view our podcasts <i className="fas fa-arrow-right ml-1"></i>
          </div>
        </div>
